  ...
  return (
    <>
      ...
      >
        ...
        <button
          className="bg-slate-900 text-white px-5 py-2 md:py-2.5 rounded-lg md:rounded-xl text-xs md:text-sm font-bold hover:bg-blue-600 active:scale-95 transition-all shadow-md"
          disabled={status === "submitting"}
        >
          Analyze
        </button>
